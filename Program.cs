...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("v1.23 sürümünü kullanmaktasınız, bizi tercih ettiğiniz için teşekkür ederiz.");
        ...
        string dogruLisans = "io1ciFpa0Z8DB1iweTrdWGeXurV63MHG8igAWouGMd";


        if (girilenLisans == dogruLisans)
        {
            Console.WriteLine("Lisansınız aktif edilmiştir, iyi kullanımlar.");
        }
        else
        {
